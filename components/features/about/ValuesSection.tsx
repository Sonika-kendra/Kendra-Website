      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="group p-6 rounded-xl border border-white/20 bg-white/10 backdrop-blur-md text-white transition duration-300 hover:-translate-y-2 hover:bg-white/20 hover:shadow-xl">
            <Target className="h-6 w-6 text-white mb-4 transition group-hover:scale-110" strokeWidth={1.5} />
            <h3 className="font-display font-semibold text-white">Tailored Strategy</h3>
          ...
          <div className="group p-6 rounded-xl border border-white/20 bg-white/10 backdrop-blur-md text-white transition duration-300 hover:-translate-y-2 hover:bg-white/20 hover:shadow-xl">
            <Zap className="h-6 w-6 text-white mb-4 transition group-hover:scale-110" strokeWidth={1.5} />
            <h3 className="font-display font-semibold text-white">Cross-Functional Expertise</h3>
            <p className="mt-2 text-sm text-white/80">
          ...
          <div className="group p-6 rounded-xl border border-white/20 bg-white/10 backdrop-blur-md text-white transition duration-300 hover:-translate-y-2 hover:bg-white/20 hover:shadow-xl">
            <Users className="h-6 w-6 text-white mb-4 transition group-hover:scale-110" strokeWidth={1.5} />
            <h3 className="font-display font-semibold text-white">Action-Oriented Delivery</h3>
            <p className="mt-2 text-sm text-white/80">
          ...
          <div className="group p-6 rounded-xl border border-white/20 bg-white/10 backdrop-blur-md text-white transition duration-300 hover:-translate-y-2 hover:bg-white/20 hover:shadow-xl">
            <CheckCircle2 className="h-6 w-6 text-white mb-4 transition group-hover:scale-110" strokeWidth={1.5} />
            <h3 className="font-display font-semibold text-white">Trusted Partner Mindset</h3>
            <p className="mt-2 text-sm text-white/80">
