    ...
    <footer className="bg-bg text-text border-t border-border">
      ...
      <div className="w-full px-20 py-8">
        <div className="grid gap-8 md:grid-cols-5">
          ...
          {/* Resources */}
          <div>
            <h5 className="mb-3 font-semibold">Resources</h5>
          ...
          {/* About */}
          <div>
            <h5 className="mb-3 font-semibold">About Kendra</h5>
            <ul className="space-y-2 text-sm text-text/80">
          ...
          {/* Contact */}
          <div>
            <h5 className="mb-3 font-semibold">Contact Us</h5>
